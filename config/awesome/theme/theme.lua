...
local themes_path = gfs.get_xdg_config_home()
local theme_path = themes_path .. 'awesome/theme/'
...
theme.master_width_factor = 0.40
theme.column_count = 2
theme.border_width  = dpi(0)
theme.border_normal = "#000000"
theme.border_focus  = "#803414"
